					...
					<table id="table" class="table">
						...
						<tbody>
							...
							foreach ($cur as $result) {
								...
								?>
								<td> &#8369 <output>
										<?php echo number_format($result->ORDEREDPRICE, 2); ?>
									</output></td>
								<?php
				...
				WHERE   s.`CUSTOMERID`=c.`CUSTOMERID` and ORDEREDNUM=" . $_SESSION['ordernumber'];
					...
					<div class="row">
						...
						<div class="col-md-6 pull-right">
							<p align="right">Total Price : &#8369
								<?php echo number_format($subtot, 2); ?>
							</p>
							<p align="right">Delivery Fee : &#8369
								<?php echo number_format($price, 2); ?>
							</p>
							<p align="right">Overall Price : &#8369
								<?php echo number_format($cur->PAYMENT, 2); ?>
							</p>
						</div>
					</div>
